...
export const dateOnlyNullableTransformer: ValueTransformer = {
  to: (value?: Date | null): string | null => (value == null ? null : value.toISOString().slice(0, 10)),
  from: (value: string | null): Date | null => (value == null ? null : new Date(`${value}T00:00:00.000Z`)),
};
